...
- String slicing: `[start:end]` now also slices strings, not just arrays
  (e.g. `"abcdefghi" | .[2:4]` → `"cd"`). Bounds follow the same rules as
  array slices (optional, negative from the end, clamped), and strings are
  sliced by Unicode code point so multibyte characters are never split.
...
[Unreleased]: https://github.com/mangrisano/jpick/compare/v2.9.1...HEAD
[2.9.1]: https://github.com/mangrisano/jpick/releases/tag/v2.9.1
[2.9.0]: https://github.com/mangrisano/jpick/releases/tag/v2.9.0
[2.8.0]: https://github.com/mangrisano/jpick/releases/tag/v2.8.0
